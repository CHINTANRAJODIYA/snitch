            ...
            <div className='container-all'>
                <Row className='mb-5'>
                            ...
                            <Col lg={12} className='mb-3'>
                                {product.product_img && Array.isArray(product.product_img) && (
                                    ...
                                    {product.product_img.map((item, index) => (
                                        <Image src={getImageUrl(item)} height={130} className='mb-3'></Image>
                                    ))}
                                </Col>
                            )}</Col>
                        </Row>
                    ...
                    {product.product_img && product.product_img.length > 0 && (
                        <Image src={getImageUrl(product.product_img[0])} height={900}></Image>
                    )}
                    </Col>
                    <Col>
                        <Row className='mt-5'>
                            ...
                            <Col lg={12} className='d-flex mt-4'>
                                ...
                                <div className='pro-detail-offer'>
                                    Get this for <b> Rs. 1,169</b> <br></br>
                            ...
                            <Col lg={12} className='d-flex mt-2'>
                                <Image src='https://www.snitch.co.in/cdn/shop/files/offer_icon-1_20x.png?v=1615371278/' height={20} className='mt-2 me-2'></Image>
                                <div className='pro-detail-offer'>
                                    Get this for <b> Rs. 1,039</b> <br></br>
                            ...
                            <Col lg={12} className='d-flex mt-2'>
                                <Image src='https://www.snitch.co.in/cdn/shop/files/offer_icon-1_20x.png?v=1615371278/' height={20} className='mt-2 me-2'></Image>
                                <div className='pro-detail-offer'>
                                    Get this for <b> Rs. 1,104</b> <br></br>
                                    Flat 15% Off on minimum purchase of 2699/- <br></br>
                                    Code: <b>FLAT15</b>
                                </div>
                            </Col>
                            <Col lg={12} className='d-flex mt-2 mb-4'>
                                ...
                                <div className='pro-detail-offer'>
                                    Get this for <b> Rs. 1,039</b> <br></br>
                                    Flat 20% Off on minimum purchase of 3999/- <br></br>
                                    Code: <b>FLAT20</b>
                                </div>
                            </Col>
                            <hr></hr>
